...
//======================================================================
bool CUserMsg::MessageBegin(int iMsgID, GLOBALID gidRecvID)
{
...
//======================================================================
bool CUserMsg::MessageEnd(CClient* pSocket)
{
	...
	bool bResult = pSocket->SendBuf(gidCurRecv, (const unsigned char*)pvuMsgBuf, dwuMsgPos);
