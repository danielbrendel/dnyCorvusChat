...
//======================================================================
typedef DWORD GLOBALID; //Global ID is valid for CLIENTID and CHANNELID. Both must be defined as the same type!
//======================================================================
...
public:
	...
	bool MessageBegin(int iMsgID, GLOBALID gidRecvID);
	bool MessageEnd(CClient* pSocket);
